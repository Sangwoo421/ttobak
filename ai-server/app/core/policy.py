...
TONES: dict[str, dict] = {
    "friendly": {
        "speed": 0.85,
        "instructions": "밝고 또렷한 30대 여성 은행 안내원의 목소리로, 어르신 고객에게 안내하듯 천천히 또박또박 읽는다. 문장 사이에 짧게 쉰다. 목소리를 늙거나 떨리게 만들지 말 것.",
    },
    "confirm": {
        "speed": 0.8,
        "instructions": "같은 30대 여성 은행 창구 직원이 중요한 내용을 확인하듯, 단어 사이를 띄어 또박또박 읽는다. 톤을 살짝 낮추고 속도를 더 늦춘다. 목소리를 늙게 만들지 말 것.",
    },
}
